...
const products: Product[] = [
  {
    ...
    description: 'Огнестойкий костюм для сварочных работ с усиленными швами',
    price: 'от 4 500 ₽',
    image: 'https://cdn.poehali.dev/projects/1c2a157e-19ec-4e79-bcc9-2f7209a38826/files/34c12aac-d9c0-4daa-98aa-6b94deb4226c.jpg',
    features: ['Огнестойкая ткань', 'Усиленные швы', 'Карманы для инструментов', 'Размеры 44-62']
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: 'Классический медицинский халат из качественной ткани',
    price: 'от 1 500 ₽',
  ...
  },
  {
    ...
    category: 'Сигнальная одежда',
    description: 'Яркий сигнальный жилет для обеспечения видимости',
    price: 'от 450 ₽',
    image: 'https://cdn.poehali.dev/projects/1c2a157e-19ec-4e79-bcc9-2f7209a38826/files/8947d5f4-4987-44dc-bb2c-e6b55aa03b3d.jpg',
    features: ['Флуоресцентная ткань', 'Светоотражающие полосы', 'Класс защиты 2', 'Удобная застежка']
  }
];
